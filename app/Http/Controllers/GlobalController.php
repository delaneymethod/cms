...
class GlobalController extends Controller
{
   	...
   	public function index(Request $request)
	{
		...
		if ($currentUser->hasPermission('view_globals')) {
			...
			return view('cp.globals.index', compact('currentUser', 'title', 'subTitle', 'globals'));
		}
	...
	public function create(Request $request)
	{
		...
		if ($currentUser->hasPermission('create_globals')) {
			...
			return view('cp.globals.create', compact('currentUser', 'title', 'subTitle'));
		}
	...
	public function confirm(Request $request, int $id)
	{
		...
		if ($currentUser->hasPermission('delete_globals')) {
			...
			return view('cp.globals.delete', compact('currentUser', 'title', 'subTitle', 'global'));
		}
