...
class ProcessOrderJob implements ShouldQueue
{
	...
	public function handle()
	{
		...
		try {
			...
			// Sends out an order created event across the system.
			
			// Listeners will pick up the event and send out notifications to the customer and to the super admin (site owner)
			OrderCreatedEvent::dispatch($this->order, $this->order->user);
			
			OrderCreatedEvent::dispatch($this->order, $this->superAdmin);
