...
class ProductAttributeUpdated implements ShouldBroadcast
{
	...
	{
		return 'product_attribute.updated';
	}
	...
	{
		return new PrivateChannel('product_attributes.'.$this->productAttribute->id);
	}
}
