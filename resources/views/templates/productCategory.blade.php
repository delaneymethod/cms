				...
				<div class="row d-flex h-100 justify-content-start products">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						...
						@foreach ($products as $product)
							<div class="row">
								<div class="col-12 col-sm-6 col-md-3 col-lg-2 col-xl-2 align-self-center text-center"><a href="{{ $product->url }}" title="{{ $product->short_name }}"><img src="/assets/img/loading.svg" data-src="{{ $product->image_url }}" data-src-retina="{{ $product->image_url }}" class="img-fluid" alt="{{ $product->short_name }}"></a></div>
