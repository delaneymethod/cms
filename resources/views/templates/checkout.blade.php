			...
			<div class="row">
				<div class="col-12 text-center text-sm-center text-md-left text-lg-left text-xl-left">
							...
							<div id="accordion" role="tablist">
								...
								<div>
									...
									<div id="reviewCart" class="collapse" role="tabpanel" aria-labelledby="reviewYourCart" data-parent="#accordion">
										...
										<div class="row">
											<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
												<table class="table table-striped table-responsive" cellspacing="0" border="0" cellpadding="0" width="100%">
													<thead>
														<tr>
													...
													<tbody>
														@foreach ($cart->product_commodities as $productCommodity)
															...
															<tr>
																<td class="align-middle text-center"><a href="{{ $productCommodityProduct->url }}" title="{{ $productCommodityProduct->title }}" target="_blank" class="text-gf-info"><img src="/assets/img/loading.svg" data-src="{{ $productCommodityProduct->image_url }}" class="lazyload img-fluid" alt="{{ $productCommodityProduct->title }}"></a></td>
					...
					@else
						<p class="font-weight-bold">There are currently no items in your cart!</p>
