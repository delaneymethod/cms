				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border: 0px solid #cccccc;border-collapse: collapse;">
					...
					<tr>
						<td align="left" valign="top" style="padding: 15px 0 0 0;font-family: Arial, sans-serif;font-size: 12px;line-height: 20px;">
							If you&#39;re having trouble clicking the &quot;{{ $subject }}&quot; button, copy and paste the URL below into your web browser: <a href="{{ $setPasswordUrl }}"title="{{ $subject }}" style="font-family: Arial, sans-serif;font-size: 12px;color: #d30e07;">{{ $setPasswordUrl }}</a>
						</td>
					</tr>
				</table>
@endsection
