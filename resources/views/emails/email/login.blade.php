				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border: 0px solid #cccccc;border-collapse: collapse;">
					...
					<tr>
						<td align="left" valign="top" style="padding: 15px 0 15px 0;font-family: Arial, sans-serif;font-size: 14px;line-height: 20px;">
							You are receiving this email because we received a login by email request for your account.
						</td>
					</tr>
					<tr>
						<td align="center" valign="top" style="padding: 15px 0 15px 0;font-family: Arial, sans-serif;font-size: 14px;line-height: 20px;">
							<a href="{{ $emailLoginUrl }}" title="{{ $subject }}" style="font-family: Arial, sans-serif;font-size: 14px;background-color: #d30e07;border: 1px solid #d30e07;border-radius: 3px;color: #ffffff;display: inline-block;font-size: 16px;line-height: 44px;text-align: center;text-decoration: none;width: 150px;-webkit-text-size-adjust: none;mso-hide: all;">Login</a>
						</td>
					</tr>
					<tr>
						<td align="center" valign="top" style="padding: 15px 0 15px 0;font-family: Arial, sans-serif;font-size: 14px;line-height: 20px;">
					...
					<tr>
						<td align="left" valign="top" style="padding: 15px 0 0 0;font-family: Arial, sans-serif;font-size: 12px;line-height: 20px;">
							If you&#39;re having trouble clicking the &quot;Login&quot; button, copy and paste the URL below into your web browser: <a href="{{ $emailLoginUrl }}"title="{{ $subject }}" style="font-family: Arial, sans-serif;font-size: 12px;color: #d30e07;">{{ $emailLoginUrl }}</a>
						</td>
					</tr>
				</table>
@endsection
