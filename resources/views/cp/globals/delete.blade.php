				...
				<div class="content padding bg-white">
					...
					<form name="removeGlobal" id="removeGlobal" class="removeGlobal" role="form" method="POST" action="/cp/globals/{{ $global->id }}">
						...
						<div class="form-buttons">
							...
							@endif
							<button type="submit" name="submit_remove_global" id="submit_remove_global" class="pull-right float-sm-right float-md-none float-lg-none float-xl-none btn btn-danger" tabindex="1" title="Delete">Delete</button>
						</div>
					</form>
				</div>
