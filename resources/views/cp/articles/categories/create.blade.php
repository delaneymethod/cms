...
@section('formButtons')
	<div class="form-buttons">
		...
		@endif
		<button type="submit" name="submit_create_article_category" id="submit_create_article_category" class="pull-right btn btn-primary" tabindex="4" title="Save Changes">Save Changes</button>
	</div>
@endsection
