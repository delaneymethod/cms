				...
				<div class="content padding bg-white">
					...
					<form name="removeArticle" id="removeArticle" class="removeArticle" role="form" method="POST" action="/cp/articles/{{ $article->id }}">
						...
						<div class="form-buttons">
							...
							@endif
							<button type="submit" name="submit_remove_article" id="submit_remove_article" class="pull-right float-sm-right float-md-none float-lg-none float-xl-none btn btn-danger" tabindex="1" title="Delete">Delete</button>
						</div>
					</form>
				</div>
