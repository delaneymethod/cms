...
@section('title', 'Create Category - Categories - '.config('app.name'))
@section('description', 'Create Category - Categories - '.config('app.name'))
@section('keywords', 'Create, Category, Categories, '.config('app.name'))
		...
		<div class="row wrapper">
			...
			<div class="{{ $mainSmCols }} {{ $mainMdCols }} {{ $mainLgCols }} main">
				...
				<div class="content padding bg-white">
					...
					<form name="createCategory" id="createCategory" class="createCategory" role="form" method="POST" action="/cp/categories">
						{{ csrf_field() }}
