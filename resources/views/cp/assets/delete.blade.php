				...
				<div class="content padding bg-white">
					...
					<form name="removeAsset" id="removeAsset" class="removeAsset" role="form" method="POST" action="/cp/assets/{{ $asset->id }}">
						...
						<div class="form-buttons">
							...
							@endif
							<button type="submit" name="submit_remove_asset" id="submit_remove_asset" class="pull-right float-sm-right float-md-none float-lg-none float-xl-none btn btn-danger" tabindex="1" title="Delete">Delete</button>
						</div>
					</form>
				</div>
