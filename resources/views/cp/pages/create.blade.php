				...
				<div class="content padding bg-white">
					...
					<form name="createPage" id="createPage" class="createPage" role="form" method="POST" action="/cp/pages">
						...
						<div class="form-group">
							...
							<input type="text" name="title" id="title" class="form-control" value="{{ old('title') }}" placeholder="New Page" tabindex="1" autocomplete="off" aria-describedby="helpBlockTitle" required autofocus>
							@if ($errors->has('title'))
						...
						<div class="form-group">
							...
							<input type="text" name="slug" id="slug" class="form-control" value="{{ old('slug') }}" placeholder="new-page" tabindex="2" autocomplete="off" aria-describedby="helpBlockSlug" required>
							@if ($errors->has('slug'))
