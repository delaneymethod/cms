				...
				<div class="content padding bg-white">
					...
					<form name="editPage" id="editPage" class="editPage" role="form" method="POST" action="/cp/pages/{{ $page->id }}">
						...
						<div class="form-group">
							...
							<select name="parent_id" id="parent_id" class="form-control {{ ($page->id == 1) ? 'text-disabled' : '' }}" tabindex="4" aria-describedby="helpBlockParentId" {{ ($page->id == 1) ? 'disabled' : 'required' }}>
