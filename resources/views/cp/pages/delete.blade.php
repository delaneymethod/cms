				...
				<div class="content padding bg-white">
					...
					<form name="removePage" id="removePage" class="removePage" role="form" method="POST" action="/cp/pages/{{ $page->id }}">
						...
						<div class="form-buttons">
							...
							@endif
							<button type="submit" name="submit_remove_page" id="submit_remove_page" class="pull-right float-sm-right float-md-none float-lg-none float-xl-none btn btn-danger" tabindex="1" title="Delete">Delete</button>
						</div>
					</form>
				</div>
