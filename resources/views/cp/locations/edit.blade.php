...
@section('formButtons')
	<div class="form-buttons">
		@if ($currentUser->hasPermission('view_locations'))
			<a href="/cp/locations" title="Cancel" class="btn btn-outline-secondary" tabindex="16" title="Cancel">Cancel</a>
		@endif
		<button type="submit" name="submit_edit_location" id="submit_edit_location" class="pull-right btn btn-primary" tabindex="15" title="Save Changes">Save Changes</button>
	</div>
@endsection
