				...
				<div class="content padding bg-white">
					...
					<form name="removeLocation" id="removeLocation" class="removeLocation" role="form" method="POST" action="/cp/locations/{{ $location->id }}">
						...
						<div class="form-buttons">
							...
							@endif
							<button type="submit" name="submit_remove_location" id="submit_remove_location" class="pull-right float-sm-right float-md-none float-lg-none float-xl-none btn btn-danger" tabindex="1" title="Delete">Delete</button>
						</div>
					</form>
				</div>
