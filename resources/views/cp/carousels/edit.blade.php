...
@section('formButtons')
	<div class="form-buttons">
		@if ($currentUser->hasPermission('view_carousels'))
			<a href="/cp/carousels" title="Cancel" class="btn btn-link text-secondary" title="Cancel">Cancel</a>
		@endif
		...
		<button type="submit" name="submit_edit_carousel" id="submit_edit_carousel" class="pull-right btn btn-primary" title="Save Changes"><i class="icon fa fa-check-circle" aria-hidden="true"></i>Save Changes</button>
	</div>
@endsection
