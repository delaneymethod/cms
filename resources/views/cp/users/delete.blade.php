				...
				<div class="content padding bg-white">
					...
					<form name="removeUser" id="removeUser" class="removeUser" role="form" method="POST" action="/cp/users/{{ $user->id }}">
						...
						<div class="form-buttons">
							...
							@endif
							<button type="submit" name="submit_remove_user" id="submit_remove_user" class="pull-right float-sm-right float-md-none float-lg-none float-xl-none btn btn-danger" tabindex="1" title="Delete">Delete</button>
						</div>
					</form>
				</div>
