...
@section('title', 'Permissions - Advanced - Dashboard - '.config('app.name'))
@section('description', 'Permissions - Advanced - Dashboard - '.config('app.name'))
@section('keywords', 'Permissions, Advanced, Dashboard, '.config('app.name'))
