...
@section('title', 'Set Password - '.config('cms.client.name'))
@section('description', 'Set Password - '.config('cms.client.name'))
@section('keywords', 'Set, Password, '.config('cms.client.name'))
